...
block1.addEventListener("dragend",function(event) {
  ...
  if(zone1.blockInZone(dotX, dotY, dotX2, dotY2)){
    block1.style.top = (event.pageY - 100 - offY) + 'px';
    block1.style.left = (event.pageX - 100 - offX) + 'px';
...
block2.addEventListener("dragend",function(event) {
  ...
  if(zone1.blockInZone(dotX, dotY, dotX2, dotY2)){
    block2.style.top = (event.pageY - 100 - offY) + 'px';
    block2.style.left = (event.pageX - 100 - offX) + 'px';
